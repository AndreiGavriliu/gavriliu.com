...
# featureImageAlt: 'Sealed secrets by ChatGPT'
# featureImageCap: 'Sealed secrets by ChatGPT'
# thumbnail: 'image.png'
...
I decided to push my Kubernetes manifests to GitHub because running Git locally on the same k3s cluster as ArgoCD seemed like asking for trouble. I mean, what happens if something goes wrong?<br>
<!--more-->
...
## What are Bitnami’s Sealed Secrets?
